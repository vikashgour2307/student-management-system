...
<body>
  ...
  <body>
    ...
    <div class="sidenav">
      <aside class="left">
             <ul>
          <li> <a class='active' href="#about">Dashboard</a></li>
          <li><a href="allemp.php">Employees</a></li>
    ...
    <div class="main-cont">
      ...
      <h3 class="m-3">All Users Registerd:</h3>
...
';
if($row['status'] == 1){
    echo' <a href="status.php?Id='.$row['reg_no'].'"><button class="btn btn-success active " id="'.$row['reg_no'].'">Active</button>';
  }
  else{
      echo' <a href="status.php?Id='.$row['reg_no'].'"><button class="btn btn-danger inactive" id="'.$row['reg_no'].'">Inactive</button>';
  }
  echo'
